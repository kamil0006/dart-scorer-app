...
${strings.trainingSessions}: ${result.importedTrainingSessions}`,
			...
			const errorMessage =
				error instanceof Error && error.message.includes('Invalid backup format')
	...
	return (
		<SafeAreaView style={styles.container}>
					...
					<View style={styles.backupSection}>
						...
						<View style={styles.backupButtons}>
							<Pressable
								...
								<MaterialIcons name='file-upload' size={18} color='#000' />
			...
			<Modal visible={customModalVisible} transparent={true} animationType='fade' onRequestClose={closeCustomModal}>
